...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(4).locale('pl');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(12).module('twitter',[])
	    .factory('Twitter', __webpack_require__(115))
	    .controller('TwitterCtrl', __webpack_require__(116));
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	console.log('');
	__webpack_require__(12).module('news', [])
	    .factory('News', __webpack_require__(117))
	    .controller('NewsCtrl', __webpack_require__(118));
	module.exports ='news';
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	__webpack_require__(12).module('partners',[])
	    .factory('Partners', __webpack_require__(119))
	    .controller('PartnersController', __webpack_require__(120));
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('v4p',['ngCookies','cfp.hotkeys','ui.bootstrap', 'hmTouchEvents'])
	    .factory('Vote', __webpack_require__(121))
	    .factory('Voting', __webpack_require__(122))
	    .controller('VotingController', __webpack_require__(123));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ngModule = __webpack_require__(12)
			.module('pages', ['ngResource'])
			.factory('Pages', __webpack_require__(124))
			.directive('page', __webpack_require__(125));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function VotingController(Voting, hotkeys, $modal, $scope) {
		...
		vm.showModal = function (speakers) {
			...
			speakerModal = $modal.open({
				...
				controller: /* @ngInject */ ["persons", "$scope", "hotkeys", function (persons, $scope, hotkeys) {
					hotkeys
							.add({
								persistent: false,
								combo: 'alt+right',
	...
	VotingController.$inject = ["Voting", "hotkeys", "$modal", "$scope"];
